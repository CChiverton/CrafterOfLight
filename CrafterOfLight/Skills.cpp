...
namespace Skills {
	...
	const std::array<SkillInformation, 26> SkillArray = { {			 /* CP	DURABILITY	EFFICIENCY	TIME*/
		...
		{SkillName::PRUDENTTOUCH,		SkillType::TOUCH,				25,		10,		100,		3	},
		{SkillName::PREPARATORYTOUCH,	SkillType::TOUCH,				40,		20,		200,		3	},
		{SkillName::REFLECT,			SkillType::TOUCH,				6,		10,		300,		3	},
		{SkillName::TRAINEDFINESSE,		SkillType::TOUCH,				32,		0,		100,		3	},
		{SkillName::REFINEDTOUCH,		SkillType::TOUCH,				24,		10,		100,		3	},
		{SkillName::WASTENOTI,			SkillType::BUFF,				56,		0,		120,		2	},
		{SkillName::WASTENOTII,			SkillType::BUFF,				98,		0,		120,		2	},
		{SkillName::GREATSTRIDES,		SkillType::BUFF,				32,		0,		120,		2	},
		{SkillName::INNOVATION,			SkillType::BUFF,				18,		0,		120,		2	},
		{SkillName::VENERATION,			SkillType::BUFF,				18,		0,		120,		2	},
		{SkillName::FINALAPPRAISAL,		SkillType::BUFF,				1,		0,		120,		2	},
		{SkillName::MASTERSMEND,		SkillType::REPAIR,				88,		-30,	120,		3	},
		{SkillName::MANIPULATION,		SkillType::REPAIR,				96,		0,		120,		2	},
		{SkillName::IMMACULATEMEND,		SkillType::REPAIR,				112,	-255,	120,		3	},
		{SkillName::TRAINEDPERFECTION,	SkillType::OTHER,				0,	0	,		0,			3	},
		{SkillName::OBSERVE,			SkillType::OTHER,				7,	0	,		0,			3	},
		{SkillName::DELICATESYNTHESIS,	SkillType::OTHER,				32,		10,		150,		3	}
	} };
}